...
var CourseRepository = /** @class */ (function () {
    function CourseRepository() {
        this.ormRepository = typeorm_1.getRepository(Course_1.default);
    }
    CourseRepository.prototype.create = function (course) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newCourse = this.ormRepository.create(course);
                        return [4 /*yield*/, this.ormRepository.save(newCourse)];
                    case 1:
                        _a.sent();
    ...
    CourseRepository = __decorate([
        typeorm_1.EntityRepository(Course_1.default)
    ], CourseRepository);
