...
let Lesson = (_dec = (0, _typeorm.Entity)('lesson'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)(), _dec3 = Reflect.metadata("design:type", Number), _dec4 = (0, _typeorm.Column)('varchar'), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)('varchar'), _dec7 = Reflect.metadata("design:type", String), _dec8 = (0, _typeorm.Column)('varchar'), _dec9 = Reflect.metadata("design:type", String), _dec10 = (0, _typeorm.Column)('int4'), _dec11 = Reflect.metadata("design:type", Number), _dec12 = (0, _typeorm.ManyToOne)(() => _Module.default, {
  eager: true
}), _dec13 = (0, _typeorm.JoinColumn)({
  name: "module_id"
}), _dec14 = Reflect.metadata("design:type", typeof _Module.default === "undefined" ? Object : _Module.default), _dec(_class = (_class2 = (_temp = class Lesson {
  constructor() {
    ...
    _initializerDefineProperty(this, "module_id", _descriptor5, this);

    _initializerDefineProperty(this, "module", _descriptor6, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "link", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "module_id", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "module", [_dec12, _dec13, _dec14], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
